var app = angular.module('myApp', ["ngRoute", "ngAnimate", "ui.tinymce", "ngSanitize", "ui.bootstrap", "checklist-model", "td.easySocialShare"]);
...
app.config(function($routeProvider, $httpProvider){
  $routeProvider
    ...
    .when('/categories/:category', {templateUrl: 'views/posts_by_category.html', controller : 'blogCtrl'})
